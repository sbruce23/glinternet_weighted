...
compute_norms_cont_cont = function(Z, contNorms, res, weights, n, indices, numCores=1){
  numInt = nrow(indices)
  .Call("R_compute_norms_cont_cont", Z, contNorms, res, weights, n, numInt, indices[, 1], indices[, 2], numCores, double(numInt))
}
